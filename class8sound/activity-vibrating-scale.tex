...
\begin{marginfigure}[-20\baselineskip]
  ...
  \caption[Sound with a scale]{Step 1. Push the free end of the scale downwards. \footnotesize Image credit: Ingrid Sulston, licensed under CC BY-NC-SA 4.0}
\end{marginfigure}
\begin{marginfigure}
  \includegraphics{scale-vibrate}
  \caption[Sound with a scale]{Step 2. Let the pushed end go. \footnotesize Image credit: Ingrid Sulston, licensed under CC BY-NC-SA 4.0}
\end{marginfigure}
