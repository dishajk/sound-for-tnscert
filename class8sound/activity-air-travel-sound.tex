...
\begin{marginfigure}
\begin{tikzpicture}
  \node[draw] at (0,0) {Illustration of long table with a lit candle on one end and a plate and spoon used as sound making instrument on the other end};
\end{tikzpicture}
  \caption{Illustration of long table with a lit candle on one end and a plate and spoon used as sound making instrument on the other end}
\end{marginfigure}
